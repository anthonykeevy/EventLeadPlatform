...
Run ID: `story-6.4.4.1-ac10-smoke10-with-definitions`
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "Please tell us any dietary needs or allergies.",
...
```json
{
  ...
  "formId": "sales-conf-sydney-registration",
  "pages": [
    {
      "components": [
        {
          ...
          "props": {
            "height": 48,
            "label": "Please register to attend our annual sales conference in Sydney. Enter your details below.",
            "tabOrder": 1,
            "width": "880px"
          },
          "style": {
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "We'll send your registration confirmation to this email.",
            "label": "Email",
            "placeholder": "[SCRUBBED_EMAIL]",
            "tabOrder": 4,
            "width": "360px"
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Will be used for event merchandise.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "Tell us about any allergies, intolerances or dietary preferences.",
            "label": "Dietary requirements",
            "placeholder": "E.g. vegetarian, vegan, gluten-free, nut allergy \u2014 please specify",
            "tabOrder": 7,
            "width": "640px"
          },
          "style": {
        ...
        },
        {
          ...
          "props": {
            "height": 120,
            "helpText": "Please read and accept the event terms to complete registration.",
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Please include country code (use +1).",
            "label": "Phone",
            "placeholder": "[SCRUBBED_PHONE]",
            "tabOrder": 4,
            "width": "320px"
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Provide ZIP/postal code (US ZIP format expected).",
            "label": "ZIP code",
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Choose the size you'd like to receive at the event.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
        ...
        },
        {
          ...
          "props": {
            "height": 120,
            "helpText": "Select any that apply (optional).",
            "label": "Dietary requirements",
            "options": [
              {
                "label": "None",
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "We'll use this to send your confirmation and tickets.",
            "label": "Email",
            "placeholder": "[SCRUBBED_EMAIL]",
            "tabOrder": 3,
            "width": "360px"
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Optional \u2014 provide a number we can reach you on the day.",
            "label": "Phone number",
            "placeholder": "[SCRUBBED_PHONE]",
            "tabOrder": 4,
            "width": "320px"
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "label": "Other dietary details (optional)",
            "placeholder": "Please describe any other requirements or allergies",
            "tabOrder": 6,
            "width": "640px"
          },
          "style": {
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Conference tee will be provided to registered attendees.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
...
```json
{
  ...
  "formId": "annual-sales-conference-auckland-registration",
  "pages": [
    {
      "components": [
        {
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Include country code if outside New Zealand.",
            "label": "Phone",
            "placeholder": "[SCRUBBED_PHONE]",
            "tabOrder": 4,
            "width": "320px"
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "Let us know any food allergies or preferences.",
            "label": "Dietary requirements",
            "placeholder": "e.g. vegetarian, gluten-free, nut allergy",
            "tabOrder": 5,
            "width": "640px"
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "T-shirts will be provided at the event.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
      ...
      "id": "page-1",
      "title": "Annual Sales Conference \u2014 Auckland Registration"
    }
  ],
  "schemaVersion": "1.0",
  "theme": {
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "We will provide this size at check-in",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "Tell us about allergies, vegetarian/vegan needs, halal, kosher, etc.",
            "label": "Dietary requirements",
            "placeholder": "Please list any dietary needs, allergies, or preferences",
            "tabOrder": 7,
            "width": "640px"
          },
          "style": {
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Provide a number we can use for last-minute updates (include country code if outside the UK).",
            "label": "Phone number",
            "placeholder": "[SCRUBBED_PHONE]",
            "tabOrder": 4,
            "width": "320px"
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "List any allergies, intolerances or dietary preferences so we can cater accordingly.",
            "label": "Dietary requirements",
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "We'll provide an event t-shirt in this size.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "T-shirt will be provided at the event.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "Tell us about any dietary needs or allergies.",
            "label": "Dietary requirements",
            "placeholder": "e.g., vegetarian, gluten-free, nut allergy",
            "tabOrder": 7,
            "width": "640px"
      ...
      "id": "page-1",
      "title": "Annual Sales Conference \u2014 London Registration"
    }
  ],
  "schemaVersion": "1.0",
  "theme": {
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "We'll use this email for event communications.",
            "label": "Email",
            "placeholder": "[SCRUBBED_EMAIL]",
            "tabOrder": 4,
            "width": "360px"
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Please include the +1 country code in your number.",
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Provide your ZIP code (US-style ZIP).",
            "label": "ZIP code",
            "placeholder": "e.g., 90210",
            "tabOrder": 6,
            "width": "320px"
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "If you have no dietary requirements, enter 'None'.",
            "label": "Dietary requirements",
  ...
  "pages": [
    {
      "components": [
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "Mobile number for event updates and emergencies.",
            "label": "Phone",
            "placeholder": "[SCRUBBED_PHONE]",
            "tabOrder": 4,
            "width": "320px"
        ...
        },
        {
          ...
          "props": {
            "height": 110,
            "helpText": "We'll use this to order your event t-shirt.",
            "label": "T-shirt size",
            "options": [
              {
                "label": "XS",
        ...
        },
        {
          ...
          "props": {
            "height": 200,
            "helpText": "List any dietary needs or allergies we should accommodate.",
            "label": "Dietary requirements",
            "placeholder": "e.g., Vegetarian, gluten-free, nut allergy",
            "tabOrder": 6,
            "width": "640px"
