You are the Claude 4.7 primary judge for Story 6.4.6 AU-only diagnostic baseline.
...
Save your output JSON to: `_bmad-output/eval-runs/story-6.4.6-au-baseline-native-concurrency-20260430T1710/judge-package/results/judge-output-claude.json`. Do not write anywhere else. Create the file if it does not exist.
