...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("SchemaName", mssql.NVARCHAR(length=100), nullable=False),
        sa.Column("Description", mssql.NVARCHAR(length=500), nullable=True),
        sa.Column("SchemaDocument", mssql.NVARCHAR(length=None), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("DefaultsJSON", mssql.NVARCHAR(length=None), nullable=False),
        sa.Column("IsActive", mssql.BIT(), nullable=False, server_default=sa.text("1")),
        sa.Column("CreatedDate", mssql.DATETIME2(), nullable=False, server_default=sa.func.getutcdate()),
        sa.Column("CreatedBy", sa.BigInteger(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("VersionNumber", sa.Integer(), nullable=False),
        sa.Column("DefaultsJSON", mssql.NVARCHAR(length=None), nullable=False),
        sa.Column("ChangeSummary", mssql.NVARCHAR(length=500), nullable=True),
        sa.Column("CreatedDate", mssql.DATETIME2(), nullable=False, server_default=sa.func.getutcdate()),
        sa.Column("CreatedBy", sa.BigInteger(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("ScopeCode", mssql.NVARCHAR(length=20), nullable=False),
        sa.Column("ScopeName", mssql.NVARCHAR(length=100), nullable=False),
        sa.Column("Description", mssql.NVARCHAR(length=500), nullable=True),
        sa.Column("IsActive", mssql.BIT(), nullable=False, server_default=sa.text("1")),
    ...
    op.create_table(
        ...
        sa.Column("ComponentTypeCode", mssql.NVARCHAR(length=50), nullable=False),
        sa.Column("DisplayName", mssql.NVARCHAR(length=100), nullable=False),
        sa.Column("Description", mssql.NVARCHAR(length=500), nullable=True),
        sa.Column("Category", mssql.NVARCHAR(length=50), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("ComponentCode", mssql.NVARCHAR(length=100), nullable=False),
        sa.Column("DisplayName", mssql.NVARCHAR(length=200), nullable=False),
        sa.Column("Description", mssql.NVARCHAR(length=500), nullable=True),
        sa.Column("SortOrder", sa.Integer(), nullable=False, server_default=sa.text("0")),
        sa.Column("PropertiesSchemaJSON", mssql.NVARCHAR(length=None), nullable=True),
        sa.Column("StructureJSON", mssql.NVARCHAR(length=None), nullable=True),
        sa.Column("DefaultGridLayoutVerticalJSON", mssql.NVARCHAR(length=None), nullable=True),
        sa.Column("DefaultGridLayoutHorizontalJSON", mssql.NVARCHAR(length=None), nullable=True),
        sa.Column("ValidationConfigJSON", mssql.NVARCHAR(length=None), nullable=True),
        sa.Column("GlobalStylesRelevantKeys", mssql.NVARCHAR(length=None), nullable=True),
        sa.Column("IsActive", mssql.BIT(), nullable=False, server_default=sa.text("1")),
        sa.Column("IsDeleted", mssql.BIT(), nullable=False, server_default=sa.text("0")),
        sa.Column("CreatedDate", mssql.DATETIME2(), nullable=False, server_default=sa.func.getutcdate()),
        sa.Column("CreatedBy", sa.BigInteger(), nullable=True),
