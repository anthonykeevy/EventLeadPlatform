...
| **6.4.3c** | **Eval Diff + Statistics Tooling** | Add Welch/Fisher statistics, diff reports, and public harness docs for prompt-change decisions. | 🔄 **In Progress** (Draft PR #71) |
