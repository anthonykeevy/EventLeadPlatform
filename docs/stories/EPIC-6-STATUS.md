...
| **6.4.4** | **Prompt Shrink Sweeps H1/H2/H4** | Run H1/H2/H4 plus combined sweeps through the harness, ship winners, and document hypothesis evidence. | 🟡 **Evidence complete; PM/SM ship decision required** (Draft PR #72; combined locale regression found) |
