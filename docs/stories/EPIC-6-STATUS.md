...
| **6.4.4.2** | **Re-evaluate H2/H4 under rubric_v2** | Re-run the two plausible prompt-shrink candidates from Story 6.4.4 against the AC10 `rubric_v2` baseline; ship only evidence-backed winners or close measured/no-change. | 🔄 **Draft PR open** (PR #79) |
