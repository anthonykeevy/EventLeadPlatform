...
| **6.5a** | **Clarification Questions** | Situational awareness dropdowns + locale override in AI Agent panel. Pre-populate locale but allow explicit override when designing for a different audience locale. | 🔄 **Draft PR #87 open** |
