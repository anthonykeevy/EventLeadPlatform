...
| **6.4.3b** | **Eval Judge Package + Rubric ADR** | Generate Cursor judge packages, ingest judge JSON, lock rubric v1, and document the manual cross-model judge workflow. | 🔄 **In Progress** (Draft PR #70) |
