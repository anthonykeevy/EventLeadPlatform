...
**Current Focus:** Story 6.4.8 — promote AU-005 behaviour into production prompt/context storage using AU-006 lint-clean wording lessons.
...
**Story 6.4.8 Status:** 🔄 **Draft PR #85 open** — Dev-owned production prompt/context implementation to promote AU-005 behaviour with AU-006 lint-clean conflict wording and targeted p11 leakage guard.
