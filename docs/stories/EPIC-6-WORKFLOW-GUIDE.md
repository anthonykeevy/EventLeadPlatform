...
**Current Focus (updated 2026-06-03 — customer discovery sequencing change):** **(1)** **Release PR `develop` → `master`** — reconcile 6.5b–6.5d + Epic 6 Test track before production. **(2)** **Story 6.5e-landing** — customer-facing beta landing page for the Test system; PM/SM prepare story pack and SM runs `new-story.ps1`. **(3)** **Story 6.5e-vision** — image-to-form / Form Builder vision path is deferred until customer discovery provides stronger signal. **(4)** **Story 6.11 — Production Environment + CI/CD** — scheduled post-6.10 unless launch sequencing is re-planned.
...
**Story 6.5e-landing Status:** ⏳ **Next** — Customer-facing beta landing page for the Test system. Scope: replace developer homepage, CTA to `/signup`, SEO/AEO FAQ, safe examples/use cases, beta trust wording. See `story-6.5e-landing-page.md` and `docs/LANDING-PAGE-BRIEF.md`.
