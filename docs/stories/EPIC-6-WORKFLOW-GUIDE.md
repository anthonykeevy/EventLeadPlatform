...
**Story 6.5c Status:** 🟡 **Ready for Dev** (2026-05-20, PR #106 Draft) — Capability catalog cutover; story pack: `story-6.5c.md`, `STORY-6.5c-SINGLE-SESSION-DEV-PROMPT.md`.
