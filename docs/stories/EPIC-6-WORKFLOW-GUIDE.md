...
**Current Focus:** Story 6.4.4 — **Prompt Shrink Sweeps H1/H2/H4** is in progress on Draft PR #72. *Image-to-Form has moved later in the AI track after measured prompt-engineering work per the 2026-04-25 PM/Architect/SM ideation brief.*  
...
**Story 6.4.4 Status:** 🟡 **In Progress** (Draft PR #72) — H1/H2/H4 prompt shrink sweeps and hypothesis evidence.  
