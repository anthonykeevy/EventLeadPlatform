          ...
          {isPendingReview && context?.hasPendingRequest && (
            <>
              {context.pendingMessage && (
                <section className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-md">
                  <h3 className="text-sm font-semibold text-blue-800 mb-1">Message from Requester:</h3>
                  <p className="text-sm text-blue-900 whitespace-pre-wrap">{context.pendingMessage}</p>
                </section>
              )}
