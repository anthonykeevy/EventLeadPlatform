/**
 * Layout Density Selector Component for Epic 2 Story 2.2
 * Allows users to select layout density preference
 */
...
export function DensitySelector({ 
  ...
  const { state, dispatch, applyLayoutDensity } = useTheme()
